...
import es.cic.viesgo.extracciones.batch.sga.IntegradorLocker;
import es.cic.viesgo.extracciones.batch.sga.IntegradorPersonaWriter;
import es.cic.viesgo.extracciones.batch.sga.IntegradorSGAListener;
import es.cic.viesgo.extracciones.batch.sga.IntegradorSGAProcessor;
import es.cic.viesgo.extracciones.batch.sga.IntegradorSGAResumen;
...
public class BatchConfiguration
{
	...
	SimpleStepBuilder<Persona, PersonaDTO> ssb = stepBuilder.<Persona, PersonaDTO> chunk(chunkSize);
